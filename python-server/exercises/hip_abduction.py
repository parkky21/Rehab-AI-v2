...
class StandingHipAbduction(ExerciseBase):
    ...
    def process(self, landmarks):
        ...
        if left_angle > 170 and right_angle > 170:
            self._on_rep_start()
            self.stage = "down"
            self.feedback = "Raise alternating leg to side"
            
        elif left_angle < 165 and right_angle >= 165 and self.stage == "down":  # Left leg abducted
        ...
        elif right_angle < 165 and left_angle >= 165 and self.stage == "down":  # Right leg abducted
